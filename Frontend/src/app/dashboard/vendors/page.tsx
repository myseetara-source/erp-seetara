...
/**
 * Vendor Management - Split View Layout
 * Modern ERP-style interface with sidebar list + detail view
 * 
 * Design: Linear/Stripe Dashboard inspired
 */
...
function VendorDetailView({ vendorId, onRefresh }: VendorDetailViewProps) {
  ...
  useEffect(() => {
    ...
    const fetchVendorData = async () => {
      setIsLoading(true);
      try {
        // Fetch vendor details and stats in parallel
  ...
  const STAT_CARDS = [
    {
      ...
      subValue: `${stats?.purchase_count || 0} orders`,
      icon: Package,
      color: 'text-blue-600',
      bg: 'bg-blue-50',
    },
    {
      ...
      subValue: stats?.last_payment_date ? `Last: ${new Date(stats.last_payment_date).toLocaleDateString()}` : 'No payments',
      icon: CreditCard,
    ...
    },
    {
      ...
      value: formatCurrency(stats?.balance || vendor.balance || 0),
      subValue: (stats?.balance || vendor.balance) > 0 ? 'Payable to vendor' : 'Receivable',
      icon: Wallet,
      color: (stats?.balance || vendor.balance) > 0 ? 'text-red-600' : 'text-green-600',
      bg: (stats?.balance || vendor.balance) > 0 ? 'bg-red-50' : 'bg-green-50',
    },
  ];
    ...
    <div className="h-full flex flex-col bg-gray-50 overflow-auto">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              {vendor.company_name && (
                <p className="text-gray-500">{vendor.company_name}</p>
              )}
      ...
      <div className="px-6 pb-4">
        <div className="flex gap-3">
          <Button
            size="lg"
            className="flex-1 h-12 bg-green-600 hover:bg-green-700 text-white font-medium shadow-lg shadow-green-500/20"
          >
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p className="text-gray-900 mt-1">{vendor.company_name || '-'}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-gray-900 mt-1">{vendor.pan_number || '-'}</p>
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {vendor.is_active ? 'Vendor is currently active' : 'Vendor is deactivated'}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Send payment and order updates</p>
                </div>
                <Switch />
              </div>
            </div>
