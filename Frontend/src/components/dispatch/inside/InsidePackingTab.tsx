/**
 * Inside Valley - Packing Station
 * 
 * Dedicated packing for Inside Valley orders only.
...
interface InsidePackingTabProps {
...
async function fetchInsideOrdersToPack(): Promise<PackingOrder[]> {
      ...
      <div className="flex items-center justify-between px-5 py-4 border-b bg-orange-50">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-orange-600">Inside Valley Order</p>
          </div>
        </div>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="px-5 py-3 border-b">
            ...
            {order.zone_code && (
              <Badge className="mt-2 bg-orange-100 text-orange-700">{order.zone_code}</Badge>
            )}
          </div>
...
export default function InsidePackingTab({ scannerRef, onDataChange }: InsidePackingTabProps) {
  ...
  const { data: orders = [], isLoading, refetch } = useQuery({
    ...
    queryFn: fetchInsideOrdersToPack,
  });
      ...
      <div className="px-4 py-3 border-b flex items-center gap-3">
        <div className="flex-1 relative">
          ...
          <Input
            ...
            placeholder="Scan Inside Valley order..."
            className="h-11 pl-12 text-lg font-mono border-2 border-orange-200 focus:border-orange-500"
          />
        </div>
        ...
        <Button 
          ...
          className={cn(
            "gap-2",
            selectedOrderIds.size > 0 && "border-orange-500 text-orange-600 hover:bg-orange-50"
          )}
            ...
            {isLoading ? (
              ...
              <tr>
                <td colSpan={7} className="py-12 text-center">
                  ...
                  <p className="text-gray-500">No Inside Valley orders to pack</p>
                </td>
              </tr>
            ) : (
              filteredOrders.map((order) => (
                <tr
                  ...
                  className={cn(
                    ...
                    selectedOrderIds.has(order.id) && "bg-orange-50/50"
                  )}
                >
                  ...
                  <td className="px-4 py-2.5">
                    <p className="font-medium truncate max-w-[150px]">{order.customer_name}</p>
